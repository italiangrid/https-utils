...
public interface SecurityContext {
   ...
   * 
   * @param cert
   *          The authenticated client's certificate
   */
   ...
   * 
   * @param chain
   *          The authenticated client's certificate chain
   */
  public void setClientCertChain(X509Certificate[] chain);

  /**
   * Returns the name of the authenticated client in RFC2253 string format for
   * distinguished names.
   *
  ...
  /**
   * Sets the {@link X500Principal} of the authenticated client's certificate.
   * 
   * @param principal
   *          The Principal of the authenticated client.
   */
  public void setClientX500Principal(X500Principal principal);

  /**
   * Returns the name of the authenticated client's certificate in OpenSSL
   * /-separated format for distinguished names.
   * 
  ...
  /**
   * Sets the name of the authenticated client's certificate in OpenSSL
   * /-separated format for distinguished names.
   * 
   * @param clientName
   *          the client name in OpenSSL /-separated format
   */
  public void setClientName(String clientName);

  /**
   * Returns the name of the issuer of the authenticated client's certificate in
   * OpenSSL /-separated format for distinguished names.
   * 
  ...
  /**
   * Sets the name of the issuer of the authenticated client's certificate in
   * OpenSSL /-separated format for distinguished names.
   * 
   * @param issuerName
   *          the issuer name in OpenSSL /-separated format
   */
  public void setIssuerName(String issuerName);

  /**
   * Returns the name of the issuer of the authenticated client's certificate in
   * RFC 2253 string format for distinguished names.
   *
   * @return String The name of the authenticated client.
   */
  ...
  /**
   * Returns the {@link X500Principal} of the issuer of the authenticated
