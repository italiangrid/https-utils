...
public final class Strings {
   ...
   * @param delimiter
   *          the delimiter, if null, then ',' (comma) will be used
   * 
   * @return the list of values, without nulls, or null if the delimited value
  ...
  public static List<String> toList(String valuesStr, String delimiter) {
    ...
    StringTokenizer valueTokens = new StringTokenizer(trimmedValueStr,
      delimiter);
